...
insert into public.resources (
  ...
  ($$psychedelics-today$$, $$partner$$, $$Psychedelics Today$$, $$A media and education platform producing psychedelic journalism, podcasts, courses, events, and public conversations for people exploring psychedelics.$$, $$https://psychedelicstoday.com/$$, $$Partner organizations$$, $$https://psychedelicstoday.com/wp-content/uploads/2022/10/cropped-PSY_001-Psychedelics-Logo_v1.2_Primary-Horizontal-Logo-1.png$$, $$Psychedelics Today logo with a multicolor circular mark and wordmark.$$, null, null, $$A media and education platform producing psychedelic journalism, podcasts, courses, events, and public conversations for people exploring psychedelics.$$, null, null, null, $$Psychedelics Today$$, false, 530, $$published$$)
