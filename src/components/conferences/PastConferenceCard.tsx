  ...
  return (
    <article className="flex h-full min-w-0 flex-col rounded-lg border border-zinc-200 bg-white p-3 shadow-sm sm:p-4">
      <div className="flex flex-1 flex-col">
        {dateRange && <p className="text-xs font-medium text-zinc-400">{dateRange}</p>}
      ...
      <div className="mt-4 pt-4">
        {conference.drive_folder_url ? (
          ...
          <span className="inline-flex min-h-11 items-center rounded-lg bg-zinc-100 px-3 py-2 text-sm font-medium text-zinc-400 sm:min-h-0">
            Photos coming soon
          </span>
        )}
      </div>
