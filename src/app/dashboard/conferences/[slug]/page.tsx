          ...
          <div className="mt-6 flex flex-wrap items-center gap-2">
            ...
            {conference.whatsapp_url ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex min-h-11 items-center gap-2 rounded-lg bg-emerald-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-emerald-700 sm:min-h-0"
              >
                <WhatsAppIcon />
              ...
              <button
                type="button"
                disabled
                className="inline-flex min-h-11 cursor-not-allowed items-center gap-2 rounded-lg bg-zinc-100 px-4 py-2 text-sm font-medium text-zinc-400 sm:min-h-0"
              >
                <WhatsAppIcon />
                Chat coming soon
              </button>
